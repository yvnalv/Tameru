...
| Transaction references a missing/inactive category | `category_not_found` | 422 |
...
| Deactivate a category that has children | `category_in_use` | 409 |
| Deactivate a system category | `category_is_system` | 409 |
